...
feature 'TrueAutomation.IO capybara example' do
  scenario 'EC flow - create new pipeline' do
    ...
    # find(ta('EC:picker:content:nameInput')).set('pipeline'+SecureRandom.hex(5))
    # find(ta('EC:content:nameInput')).set('pipeline'+SecureRandom.hex(5))
    find(:xpath, ta('EC:content:nameInput', "//input[@placeholder='Name']")).set('pipeline'+SecureRandom.hex(5))
