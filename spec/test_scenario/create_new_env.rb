...
#
    ...
    find(:xpath, ta('EC:content:createNewEnv', "(//div[@class='object-create__type'])[1]")).click
    # find(:xpath, "(//div[@class='object-create__type'])[1]").click

    # find(ta('EC:picker:content:nameInput')).set('env'+SecureRandom.hex(5))
    # find(ta('EC:content:nameInput')).set('env'+SecureRandom.hex(5))
    find(:xpath, ta('EC:content:nameInput', "//input[@placeholder='Name']")).set('env'+SecureRandom.hex(5))
    # find(:xpath, "//input[@placeholder='Name']").set('env'+SecureRandom.hex(5))
